...
describe("expandWallSelectionZipItems", () => {
  ...
  test("empty selection yields no entries", () => {
    expect(
      expandWallSelectionZipItems(
        [],
        [
  ...
  test("skips missing ids without shifting later positions", () => {
    expect(
      expandWallSelectionZipItems(
        ["missing", "a"],
        [
  ...
  test("duplicate selected ids expand twice when present", () => {
    expect(
      expandWallSelectionZipItems(
        ["a", "a"],
        [
      ...
      { name: "Solo", image_path: "u/a.jpg", position: 0 },
      { name: "Solo", image_path: "u/a.jpg", position: 1 },
    ])
  })

  test("skips sequence siblings without an image_path", () => {
    expect(
      expandWallSelectionZipItems(
        ["cover"],
        [
    ...
    ).toEqual([{ name: "Burst", image_path: "u/cover.jpg", position: 0 }])
  })
})
